...
class _ChatScreenState extends ConsumerState<ChatScreen> {
  ...
  Widget build(BuildContext context) {
    final provider = widget.aiType == AiType.myAi
        ? myAiChatProvider
        : doctorAiChatProvider;
    ...
    return Column(
      children: [
        ...
        _ChatHeader(aiType: widget.aiType, userName: user?.firstName ?? 'there'),
        ...
        if (chatState.isTyping)
          _TypingStatusBar(aiType: widget.aiType),

        // Input area
        ChatInput(
          isTyping: chatState.isTyping,
          onSend: (msg) =>
              ref.read(provider.notifier).sendMessage(msg),
        ),
      ],
    );
  }
